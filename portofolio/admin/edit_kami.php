...
<script type="text/javascript" src="../js/jquery.min.js"></script>							<!--JQuery standard library-->		
	...
	$( document ).ready(function() {
	 ...
	 document.getElementById("pemberitahuan3").innerHTML="";
	  ...
	  $('#no').change(function () {
	 $("#no").css("border","solid #a9a9a9 1px");
	...
	if(no==""){
	event.preventDefault();
	document.getElementById("pemberitahuan4").innerHTML=" No Wa Tujuan  ";
	document.getElementById("pemberitahuan4").style.color = "red";
	$("#no").css("border","solid red 1px");	
	}
	...
	include "../koneksi.php";
	$id=$_GET['id'];
	$query="SELECT * FROM tentang_kami where id_kami='$id'";
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Edit Tentang Kami </h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
				...
				<div align="center">
				  <form action="olahdata/kami.php" name="form1" method="post" enctype="multipart/form-data">
				     <input name="id" type="hidden" class="form-control" id="id" value="<?php echo"$hasil_lopping[0]";?>"/>
					<p> Data Tentang Kami </p>
				    <table width="616" border="0"><tr>
					  ...
					  <tr>
					    ...
					    <td><label>
                            <table width="452" border="0">
                              <tr>
                                <td width="188"><input name="no" type="text" class="form-control" id="no" value="<?php echo"$hasil_lopping[3]";?>"/></td>
                                <td></td>
